export default {
  ...
  "date": "Published on",
  "P_01": `In this documented essay we will understand and delve deeper into how models
Customized Artificial Intelligence can be functional when it comes to
