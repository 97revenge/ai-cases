export default {
  ...
  "date": "Published on",
  "P_01": `In this documented essay we will __understand and delve deeper into how models
Customized Artificial Intelligence can be functional__ when it comes to
learn and replicate, in different ways.`,
